...
@Component({
  selector: 'app-supervisor-profile-view-full-student',
  templateUrl: './supervisor-profile-view-full-student.component.html',
  styleUrls: ['./supervisor-profile-view-full-student.component.css']
})
export class SupervisorProfileViewFullStudentComponent implements OnInit {
    //students: student[];
